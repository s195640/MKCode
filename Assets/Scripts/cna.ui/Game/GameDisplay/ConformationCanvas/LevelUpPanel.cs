    ...
    public class LevelUpPanel : BasePanel {
        ...
        public void SetupUI(GameAPI ar, Action<GameAPI> callback, List<int> actionOffering, List<int> skillOffering, List<int> skills) {
            ...
            for (int i = 0; i < actionOffering.Count; i++) {
                ...
                actionSlotOffering[i].SetupUI(actionOffering[i], CardHolder_Enum.LevelUp);
            }
            ...
            for (int i = 0; i < skills.Count; i++) {
                ...
                levelUpSkillSlots[i].SetupUI(skills[i], CardHolder_Enum.LevelUp);
            }
            ...
            this.skillOffering.ForEach(c => {
                ...
                s.SetupUI(c, CardHolder_Enum.LevelUp);
        ...
        public void OnClick_SelectActionOfferingCard(int index) {
            ...
            selectedAction.SetupUI(actionOffering[actionOfferingIndex], CardHolder_Enum.LevelUp);
            if (index != 0 && skillOfferingIndex >= 0) {
                skillOfferingIndex = -1;
                selectedSkill.SetupUI(0, CardHolder_Enum.LevelUp);
            }
        }
        ...
        public void OnClick_SelectSkillCard(int index) {
            skillOfferingIndex = -1;
            skillIndex = index;
            selectedSkill.SetupUI(skills[skillIndex], CardHolder_Enum.LevelUp);
        }

        public void OnClick_SelectSkillOfferingCard(int uniqueCardId) {
            skillIndex = -1;
            skillOfferingIndex = skillOffering.FindIndex(c => c == uniqueCardId);
            selectedSkill.SetupUI(skillOffering[skillOfferingIndex], CardHolder_Enum.LevelUp);
        ...
        public void Clear() {
            ...
            skillIndex = -1;
            selectedSkill.SetupUI(0, CardHolder_Enum.LevelUp);
            selectedAction.SetupUI(0, CardHolder_Enum.LevelUp);
        }
    }
}

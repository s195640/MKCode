    ...
    public class BottomButtonContainer : MonoBehaviour {
                        ...
                        if (cleared) {
                            ...
                            switch (A.Hex.Structure) {
                                ...
                                case Image_Enum.SH_AncientRuins: {
                                    int monsterId = localPlayer.Board.MonsterData[A.Hex.GridPosition].Values[0];
                                    if (!localPlayer.VisableMonsters.Contains(monsterId)) {
                                        B1 = BottomButton_Enum.Adventure_AncientRuins_RevealMonster;
                                    } else {
                                        B1 = BottomButton_Enum.Adventure_AncientRuins;
                                    }
                                    break;
                                }
                            }
        ...
        private void configureButton(BottomButton_Enum buttonType, CNA_Button button) {
            ...
            switch (buttonType) {
                ...
                case BottomButton_Enum.Adventure_AncientRuins_RevealMonster: {
                    text = "Reveal";
                    color = CNAColor.ColorLightGreen;
                    break;
                }
        ...
        private void OnClick() {
            switch (B) {
                ...
                case BottomButton_Enum.Adventure_AncientRuins_RevealMonster: {
                    A.OnClick_Adventure_AncientRuins_RevealMonster();
                    break;
                }
            }
        }

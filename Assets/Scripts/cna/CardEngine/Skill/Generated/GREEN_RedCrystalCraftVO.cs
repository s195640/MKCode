...
namespace cna {
    public partial class GREEN_RedCrystalCraftVO : CardSkillVO {
        public GREEN_RedCrystalCraftVO(int uniqueId) : base(
            uniqueId,
            "Red Crystal Craft",
            CardType_Enum.Skill,
            SkillRefresh_Enum.Round,
            Image_Enum.SKG_red_crystal_craft,
            Image_Enum.SKG_back,
            ...
            false,
            "Once a Round: Flip this to gain one blue crystal to your Inventory, and one red mana token."
            ) { }
    }
}

...
namespace cna {
    public partial class RED_MotivationVO : CardSkillVO {
        public RED_MotivationVO(int uniqueId) : base(
            uniqueId,
            "Motivation",
            CardType_Enum.Skill,
            SkillRefresh_Enum.Round,
            Image_Enum.SKR_motivation,
            Image_Enum.SKR_back,
            ...
            false,
            "Once a round, on any players turn: Flip this to draw 2 cards. If you have the least fame (not tied), also gain one red mana "
            ) { }
    }
}

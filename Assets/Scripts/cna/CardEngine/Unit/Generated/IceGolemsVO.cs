...
namespace cna {
    public partial class IceGolemsVO : CardUnitVO {
        public IceGolemsVO(int uniqueId) : base(
            uniqueId,
            "Ice Golems",
            Image_Enum.CUE_ice_golems_x2,
            CardType_Enum.Unit_Elite,
            new List<string> { "Attack or Block 3", "Ice Attack 6" },
            ...
            new List<List<BattlePhase_Enum>> { new List<BattlePhase_Enum>() { BattlePhase_Enum.Block, BattlePhase_Enum.Attack }, new List<BattlePhase_Enum>() { BattlePhase_Enum.Attack }, new List<BattlePhase_Enum>() { } },
            CardColor_Enum.NA,
            8,
            3,
            4,
            new List<Image_Enum> { Image_Enum.I_unitkeep, Image_Enum.I_unitmage },
            new List<Image_Enum> { Image_Enum.I_resistphysical, Image_Enum.I_resistice }
            ) { }
    }
}
